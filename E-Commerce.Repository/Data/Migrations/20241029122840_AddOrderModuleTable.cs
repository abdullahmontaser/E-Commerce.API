...
{
    /// <inheritdoc />
    public partial class AddOrderModuleTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Proudect_ProudectId = table.Column<int>(type: "int", nullable: false),
                    Proudect_ProudectName = table.Column<string>(type: "nvarchar(max)", nullable: false),
